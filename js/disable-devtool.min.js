! function(e, t) {
    ...
    var k = function() {
            ...
            return u(n, [{
                ...
                value: function() {
                    var e;
                    console.warn("You don't have permission to use DEVTOOL!【type = ".concat(this.type, "】")), d.clearIntervalWhenDevOpenTrigger && ne(), window.clearTimeout(Q), d.ondevtoolopen(this.type, t), e = this.type, S[e] = !0
                }
            }, {
                key: "init",
                value: function() {}
